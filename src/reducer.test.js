import reducer from './reducer';//the reducer is default, and not a function name 
import {restartGame, makeGuess, generateAuralUpdate} from './actions';

describe('Reducer', () => {
    it('Should set the initial state when nothing is passed in', () => {
        const state = reducer(undefined, {type: '__UNKNOWN'});
//when it first starts, there should be zero guesses
        expect(state.guesses).toEqual([]);
//expect feedback
        expect(state.feedback).toEqual('Make your guess!');
//make sure correct answer generated is between or including 0 - 100
